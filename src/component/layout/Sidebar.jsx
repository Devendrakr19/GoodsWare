  ...
  return (
    <>
      <div className="pl-2 pt-2">
        <div
          className={`w-full ${isActiveSidebar ? "h-[60px] p-2" : "h-[120px] p-7"} bg-[#00cec4] rounded flex justify-center items-center`}
        >
          <img
            src="./goodsware.svg"
            alt="goodsware"
        ...
        <div
          className={`bg-[#00cec4] py-5 mt-3 rounded ${isActiveSidebar ? "h-[calc(100vh-90px)] px-3" : "h-[calc(100vh-150px)] px-4.5"}`}
        >
          <div
            className={`flex flex-col ${isActiveSidebar ? "h-[calc(100vh-165px)]" : "h-[calc(100vh-230px)]"} overflow-auto hide_scrollbar`}
          >
          ...
          <div
            ...
            className={`${isActiveSidebar ? "justify-center px-3 py-2.5" : "px-2 py-2"} hover:bg-[#335765] hover:text-[white] text-[18px] rounded flex items-center gap-[10px] cursor-pointer`}
          >
            {isActiveSidebar ? (
